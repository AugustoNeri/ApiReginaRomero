            ...
            <section id="content">
                ...
                <div id="sidebar">
                    ...
                    <label for="exampleFormControlInput1" class="form-label"><h5>Fecha de inicio (obligatorio)</h5></label>
                        ...
                        <label for="exampleFormControlInput1" class="form-label"><h5>Fecha de término (obligatorio)</h5></label>
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <label for="exampleFormControlInput1" class="form-label"><h4>Colección</h4></label>
                        <div class="categorias">     
                ...
                echo "<center><h5>Debe de escoger al menos una sucursal</h5></center>";
                    ...
                    if($_GET['cmbMesI']!=''&& $_GET['cmbMesF']!=''){
                        ...
                        ?>
                        <table>
                            <tr><td>Colección</td><td>Cantidad</td><td>%</td></tr>
                            <tr><td>Colección Regina Romero</td><td><?php echo $conCR;?></td><td><?php echo number_format($porCr,2);?>%</td></tr>
                            <tr><td>Primavera Verano</td><td><?php echo $conPV;?></td><td><?php echo number_format($porPV,2);?>%</td></tr>
                            <tr><td>Otoño Invierno</td><td><?php echo $conOI;?></td><td><?php echo number_format($porOI,2);?>%</td></tr>
                            <?php
